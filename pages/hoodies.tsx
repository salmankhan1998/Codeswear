...
const Hoodies = () => {
  const data = [
    { 
      imageUrl: "/images/hoodies/image1.jpeg",
      title: "Plain Hood",
      actualPrice: "599",
      discountedPrice: "449",
      colors: ['blue','black'],
    ...
    { 
      imageUrl: "/images/hoodies/image2.jpg",
      title: "Multi-color Hoodie",
      actualPrice: "799",
      discountedPrice: "699",
    ...
    { 
      imageUrl: "/images/hoodies/image3.jpg",
      title: "Just Do It.",
      actualPrice: "999",
      discountedPrice: "799",
    ...
    { 
      imageUrl: "/images/hoodies/image4.jpg",
      title: "Rocky",
      actualPrice: "799",
      discountedPrice: "699",
        ...
        <div className="flex flex-wrap space-y-6">
          {data.map((item,index) =>(
            ...
            <div className="rounded overflow-hidden h-96">
              <img alt="ecommerce" className="h-full object-cover" src={item.imageUrl}/>
            </div>
            <div className="">
